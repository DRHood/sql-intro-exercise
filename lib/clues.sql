...
SELECT name, population WHERE region = 'Southern Europe';
-- Holy See
...
SELECT language, countrycode FROM countrylanguages  WHERE percentage = 100;
...
SELECT countries.code, countries.name, cities.name
